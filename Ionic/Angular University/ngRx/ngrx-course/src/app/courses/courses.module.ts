...
@NgModule({
  ...
  providers: [
    CoursesHttpService, CourseEntityService, CoursesResolver, CoursesDataService,LessonEntityService
  ]
})
export class CoursesModule {

  constructor(private eds: EntityDefinitionService, private entityDataService: EntityDataService
    , private cds: CoursesDataService) {
    eds.registerMetadataMap(entityMetaData)
    entityDataService.registerService('Course', cds)
  }
