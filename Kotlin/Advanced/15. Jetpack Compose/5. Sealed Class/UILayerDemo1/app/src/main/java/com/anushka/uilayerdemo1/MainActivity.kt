...
fun MainScreen(
    ...
    Scaffold(scaffoldState = scaffoldState) {
        Column(
            ...
            if (screenState.isCountBtnVisible) {
                Button(
                    onClick = { counterViewModel.onEvent(CounterEvent.CountBtnClicked) },
                    modifier = Modifier.fillMaxWidth()
                ) {
                    Text(
                        text = "Count",
            ...
            Button(
                onClick = { counterViewModel.onEvent(CounterEvent.ResetBtnClicked) },
                modifier = Modifier.fillMaxWidth()
            ) {
                Text(
                    text = "Reset",
